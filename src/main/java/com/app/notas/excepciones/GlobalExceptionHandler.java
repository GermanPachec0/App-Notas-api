package com.app.notas.excepciones;

import com.app.notas.dto.ErrorDetalles;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NotasAppException.class)
    public ResponseEntity<ErrorDetalles> manejarBlogAppException(NotasAppException exception,WebRequest webRequest){
        ErrorDetalles errorDetalles = new ErrorDetalles(new Date(),exception.getMessage(), webRequest.getDescription(false));
